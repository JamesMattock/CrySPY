...
# This script writes a dummy CrySPY job
...
for molecule in molenames:
    ...
    num_mols = int(molnums[col_num_var])
...
cryspy_text.append("calc_code = QE\n")
cryspy_text.append("tot_struc = 1\n")
cryspy_text.append("nstage = 1\n")
cryspy_text.append("njob = 1\n")
cryspy_text.append("jobcmd = qsub\n")
cryspy_text.append("jobfile = qe_runscript\n")
cryspy_text.append("   \n")
...
# The structure for LAMMPS interface must be P1
...
cryspy_text.append("   \n")
cryspy_text.append("[QE]\n")
cryspy_text.append("qe_infile = pwscf.in\n")
cryspy_text.append("qe_outfile = pwscf.out\n")
cryspy_text.append("kppvol = 60\n")
cryspy_text.append("   \n")
