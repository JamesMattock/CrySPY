...
run_text.append("#PBS -l walltime=12:00:00\n")
run_text.append("#PBS -A Jolley2024c\n")
...
run_text.append("   \n")
run_text.append("mpirun -np $NCPUS -ppn 40 lmp_mpi -sf intel -pk intel 0 omp 2 -in lammps.IN -log lammps.OUT\n")
run_text.append("   \n")
